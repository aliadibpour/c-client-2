...
export const Reply = ({ style, height = 23, width = 23, color = "currentColor" }: any) => {
  return (
    <Svg
      width={width}
      height={height}
...
export const Emoji = ({
  ...
  return (
    <Svg
      ...
      style={style}
    >
      <Path d="M15 9h.01M8.99 9H9m12 3a9 9 0 1 1-18 0 9 9 0 0 1 18 0ZM6.6 13a5.5 5.5 0 0 0 10.81 0H6.6Z" />
    </Svg>
  );
};